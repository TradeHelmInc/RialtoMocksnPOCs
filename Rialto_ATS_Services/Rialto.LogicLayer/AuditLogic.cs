...
namespace Rialto.LogicLayer
{
    ...
    public string APP_APPROVAL_START = "APP_APPROVAL_START";
    public string APP_APPROVAL_SHAREHOLDER_FOUND = "APP_APPROVAL_SHAREHOLDER_FOUND";
    public string APP_APPROVAL_APPROVING_SHAREHOLDER = "APP_APPROVAL_APPROVING_SHAREHOLDER";
    public string APP_APPROVAL_APPROVED_SHAREHOLDER = "APP_APPROVAL_APPROVED_SHAREHOLDER";
