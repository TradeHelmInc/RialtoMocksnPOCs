...
namespace Rialto.ServiceLayer.service
{
    ...
    /*public class HoldingController : BaseController
    {
        ...
        [System.Web.Http.ActionName("OnSell")]
        public IActionResult OnSellSvc(HttpRequestMessage Request)
        {
            try
            {
        ...
        [System.Web.Http.HttpPost]
        [System.Web.Http.ActionName("OnBuy")]
        public IActionResult OnBuySvc(HttpRequestMessage Request)
        {
            try
            {
                var content = Request.Content;
        ...
        [System.Web.Http.HttpPost]
        [System.Web.Http.ActionName("OnOrderCancelledOrExpiredSvc")]
        public IActionResult OnOrderCancelledOrExpiredSvc(HttpRequestMessage Request)
        {
            try
            {
                var content = Request.Content;
