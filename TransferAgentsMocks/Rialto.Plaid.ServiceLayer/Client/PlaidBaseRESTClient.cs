...
{
    public class PlaidBaseRESTClient : BaseRESTClient
    {
        ...
        protected BaseResponse DoPostJson(string url, Dictionary<string, string> headers, string json)
        {
            ...
            try
            {
                ...
                if (content.Contains("error_code"))
                {
                    ...
                    GenericError err = JsonConvert.DeserializeObject<GenericError>(content);
                    return new BaseResponse() { Resp = null, GenericError = err };
                }
                else
                    return new BaseResponse() { Resp = content, GenericError = null };
            ...
            {
                return new BaseResponse() { Resp = null, GenericError = new GenericError() { display_message = ex.Message, error_message = ex.Message } };
            }
        }
